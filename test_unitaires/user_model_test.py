...
def get_stability_dict():
    ...
    file_path = base_dir /"docker_volume" / "unittest" / "kpi_user_model"/ "dict_stability.pkl"
...
def get_pred_comparaison_dict():
    base_dir = Path(__file__).resolve().parent.parent 
    file_path = base_dir /"docker_volume" / "unittest" / "kpi_user_model"/ "dict_prediction_comparaison.pkl"
